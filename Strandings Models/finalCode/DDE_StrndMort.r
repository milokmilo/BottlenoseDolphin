...
# Exponential
  ...
  save(list=paste("Exp",substr(StrObj[i],4,4),sep=""), 
       file=paste("../../RObjects/M","Exp",substr(StrObj[i],4,4),".RData",sep=""))
# GLM Family=Poisson (log(y)) 
  ...
  save(list=paste("glmPois",substr(StrObj[i],4,4),sep=""), file=paste("../../RObjects/M","glmPois",substr(StrObj[i],4,4),".RData",sep=""))
# Second-degree polynomial
  ...
  save(list=paste("IIPol",substr(StrObj[i],4,4),sep=""), file=paste("../../RObjects/M","IIPol",substr(StrObj[i],4,4),".RData",sep=""))
}
...
save(file="../../RObjects/ggStrnd.RData", ggStrnd)
