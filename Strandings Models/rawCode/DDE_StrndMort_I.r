...
gg1 <- ggplot(ggData, aes(age, n, group=mod, colour=mod)) + geom_point(colour = "black", size = 2) +
        facet_grid(. ~ data, labeller=lab) + geom_line(aes(age, pred)) +
...
png("../plots/DDE_predStrdg.png", width=1000, height=800)
print(gg1)
dev.off()
#```
