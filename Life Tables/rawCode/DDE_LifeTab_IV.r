...
ggLife <- GGlifeTab[!GGlifeTab$mod=="lifeN",]
ggLife$mod <- as.character(ggLife$mod)
ggLife$mo <- substr(ggLife$mod, 5, nchar(ggLife$mod)-1)
ggLife$ag <- substr(ggLife$mod, nchar(ggLife$mod), nchar(ggLife$mod))
...
gM1 <- ggplot(ggLife,aes(age,qx, group=mod)) + 
