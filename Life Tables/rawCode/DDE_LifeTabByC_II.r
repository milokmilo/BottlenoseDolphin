...
#             Actual life tables with both total, bycatch and no bycatch data.
#         Siler mortality model and Siler life tables with both types of strandings
#                   created: (camilo.saavedra@vi.ieo.es) 11/11/2013
####################################################################################################

# inputs
# "../../RObjects/byCatch/byCatch.RData"

# outputs
# "../../RObjects/lifeTables/lifeTabNByC.RData"
# "../../RObjects/lifeTables/NByCSiler00.RData"
...
load(file="../../RObjects/byCatch/byCatch.RData")
...
for (i in 1:length(lifeTabs)){
  ...
  save(file=paste("../../RObjects/lifeTables/", lifeTabs[i], ".RData", sep=""), lifeTabNByC)
}
...
save(file="../../RObjects/lifeTables/NByCSiler00.RData", NByCSiler00)
...
#  assign("lifeSiler", get(lifeSilers[i]))
  save(file=paste("../../RObjects/lifeTables/lifeSilerNByC.RData", sep=""), lifeSilerNByC)
#}
