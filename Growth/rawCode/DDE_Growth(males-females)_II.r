...
save(file="../../RObjects/growth/vbMales.RData", vbMales)
save(file="../../RObjects/growth/vbFemales.RData", vbFemales)
...
gMatSex <- ggplot(dde, aes(age, length)) + geom_point(aes(colour=factor(sex)
#                                                          , shape=factor(maturity))
                                                          , size=4)
# by Sex
