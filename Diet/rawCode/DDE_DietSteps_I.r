...
#              
#                   C.Saavedra (camilo.saavedra@vi.ieo.es) 27/08/2013
####################################################################################################
...
### OJO! No estamos incluyendo los que no tiene merluza pero si otro alimento ###
...
par.default <- par(no.readonly=TRUE)
#png("../../plots/DDE_hkeLength.png", height=600, width=900)
par(oma=c(3,3,3,3))  
