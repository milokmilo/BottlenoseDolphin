...
Hke <- boot(ddeSp, percBoot, R=1000)
...
Hke1TS <- boot(ddeSp[ddeSp$timeSer==1,], percBoot, R=1000)
nrow(ddeSp[ddeSp$timeSer==1,]) # Dolphins per quarter
# Percentage of hake in the second part of the time series   
Hke2TS <-boot(ddeSp[ddeSp$timeSer==2,], percBoot, R=1000)
nrow(ddeSp[ddeSp$timeSer==2,]) # Dolphins per quarter
# Percentage of hake in the thirth part of the time series   
Hke3TS <-boot(ddeSp[ddeSp$timeSer==3,], percBoot, R=1000)
nrow(ddeSp[ddeSp$timeSer==3,]) # Dolphins per quarter
# Percentage of hake in the fourth part of the time series  
Hke4TS <-boot(ddeSp[ddeSp$timeSer==4,], percBoot, R=1000)
nrow(ddeSp[ddeSp$timeSer==4,]) # Dolphins per quarter
# Percentage of hake in the fifth part of the time series   
Hke5TS <- boot(ddeSp[ddeSp$timeSer==5,], percBoot, R=1000)
nrow(ddeSp[ddeSp$timeSer==5,]) # Dolphins per quarter
# Percentage of hake in the sixth part of the time series   
Hke6TS <-boot(ddeSp[ddeSp$timeSer==6,], percBoot, R=1000)
nrow(ddeSp[ddeSp$timeSer==6,]) # Dolphins per quarter
